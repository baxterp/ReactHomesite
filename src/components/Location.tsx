    ...
    <section id="location" className="full-height-section bg-[#161c26] flex items-center">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-24">
          ...
          <p className="mt-4 text-xl text-gray-400 max-w-2xl mx-auto mb-24">
            Based in Coventry, UK
          </p>
        </div>
        
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-24 items-start">
          <div className="bg-[#0e1218] rounded-lg shadow-md p-8 border border-gray-800 h-[400px] flex flex-col">
          ...
          <div className="h-[400px] bg-[#0e1218] rounded-lg shadow-md overflow-hidden border border-gray-800 relative flex items-center">
            {/* Dimming filter that allows interaction - using mix-blend-mode instead of a blocking overlay */}
            <div 
              className="absolute inset-0 bg-[#0e1218] opacity-35 z-10 pointer-events-none mix-blend-mode-multiply"
